...
export const TRANSITIONS: Readonly<Record<PaymentState, Partial<Record<TransitionInput, PaymentState>>>> = {
  ...
  // PREVIOUSLY_DENIED from CHALLENGING: a sibling case with the same beneficiary was denied while this one was open.
  CHALLENGING: {
    AUTHORIZE: "CLEARED", DENY: "QUARANTINED", INCONCLUSIVE: "QUARANTINED", EXPIRE: "QUARANTINED", BLOCK: "QUARANTINED", PREVIOUSLY_DENIED: "QUARANTINED",
  },
  QUARANTINED: {},
  CLEARED: {},
};
