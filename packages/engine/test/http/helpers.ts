import type { Principal, PayFirewall } from "../../src/core/types";
...
export const BASE = "https://payfirewall.test/api/v1";
...
export function handlerFor(api: PayFirewall, opts: Partial<HandlerOptions> = {}) {
